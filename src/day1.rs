...
fn part1(input: &str) -> u32 {
    calculate_sum_from_codes(input, false)
}
fn part2(input: &str) -> u32 {
    calculate_sum_from_codes(input, true)
}
...
mod tests {
    ...
    fn test_input_file_1() {
        let input_data = include_str!("../example/day1_part1.txt");
    ...
    fn test_input_file_2() {
        let input_data = include_str!("../example/day1_part2.txt");
